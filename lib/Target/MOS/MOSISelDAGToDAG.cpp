...
//===--------------------------------------------------------------------===//
/// MOSDAGToDAGISel - MOS specific code to select MOS machine
/// instructions for SelectionDAG operations.
///
namespace {
class MOSDAGToDAGISel : public SelectionDAGISel {
  /// Subtarget - Keep a pointer to the MOS Subtarget around so that we can
  /// make the right decision when generating code for different targets.
  const MOSSubtarget *Subtarget;
public:
  explicit MOSDAGToDAGISel(MOSTargetMachine &tm) : SelectionDAGISel(tm) {}
  ...
  StringRef getPassName() const override {
    return "MOS DAG->DAG Pattern Instruction Selection";
  }
...
SDNode* MOSDAGToDAGISel::getGlobalBaseReg() {
...
bool MOSDAGToDAGISel::SelectADDRri(SDValue Addr,
...
bool MOSDAGToDAGISel::SelectADDRrr(SDValue Addr, SDValue &R1, SDValue &R2) {
...
bool MOSDAGToDAGISel::tryInlineAsm(SDNode *N){
...
void MOSDAGToDAGISel::Select(SDNode *N) {
  SDLoc dl(N);
...
/// inline asm expressions.
bool
MOSDAGToDAGISel::SelectInlineAsmMemoryOperand(const SDValue &Op,
                                                unsigned ConstraintID,
...
/// createMOSISelDag - This pass converts a legalized DAG into a
/// MOS-specific DAG, ready for instruction scheduling.
///
FunctionPass *llvm::createMOSISelDag(MOSTargetMachine &TM) {
  return new MOSDAGToDAGISel(TM);
}
